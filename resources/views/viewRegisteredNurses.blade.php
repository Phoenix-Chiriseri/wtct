...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="jumbotron">
                <h1 class="display-4 animate__animated animate__fadeInLeft">Registered Nurses</h1>
                <hr class="my-4">
                <p class = "animate__animated animate__slideInUp">Total People For The Week {{$total}}</p>
                <p class = "animate__animated animate__slideInRight">Total People For Today {{$today}}</p>
...
<div class="container">
    ...
    <script>
        function generatePDF() {
            ...
            doc.text('Registered Nurses Report', 10, 10); // Title
            doc.fromHTML(htmlContent, 10, 20, {
                width: 190
            });
        
            // Save the PDF
            doc.save('RegisteredNursesReport.pdf');
        }
        </script>
<div class="container">
