...
<div class="container" >
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="jumbotron">
                <h1 class="display-4 animate__animated animate__fadeInLeft">Support Workers</h1>
                <hr class="my-4">
                <p class = "animate__animated animate__fadeInLeft">Total People For The Week {{$total}}</p>
                <p class = "animate__animated animate__fadeInRight"> Total People For Today {{$today}}</p>
