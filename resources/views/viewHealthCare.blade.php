...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="jumbotron">
                <h1 class="display-4 animate__animated animate__fadeInLeft">Health Care Assistants</h1>
                <hr class="my-4">
                <p class = "animate__animated animate__slideInUp">Total People For The Week {{$total}}</p>
                <p class = "animate__animated animate__wobble">Total People For Today {{$today}}</p>
...
<div class="container">
    ...
    <script>
        function generatePDF() {
            ...
            // Save the PDF
            doc.save('HealthCareWorkersReport.pdf');
        }
        </script>
